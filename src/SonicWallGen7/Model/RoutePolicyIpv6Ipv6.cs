...
namespace SonicWallGen7.Model
{
    ...
    /// IPv6 route policy.
    /// </summary>
    [DataContract(Name = "route_policy_ipv6_ipv6")]
    public partial class RoutePolicyIpv6Ipv6 : IEquatable<RoutePolicyIpv6Ipv6>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutePolicyIpv6Ipv6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RoutePolicyIpv6Ipv6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RoutePolicyIpv6Ipv6" /> class.
        /// </summary>
        ...
        public RoutePolicyIpv6Ipv6(string varInterface = default(string), decimal metric = default(decimal), RoutePolicyIpv6Ipv6Source source = default(RoutePolicyIpv6Ipv6Source), RoutePolicyIpv6Ipv6Destination destination = default(RoutePolicyIpv6Ipv6Destination), string app = default(string), string application = default(string), RoutePolicyIpv6Ipv6Service service = default(RoutePolicyIpv6Ipv6Service), RoutePolicyIpv6Ipv6Gateway gateway = default(RoutePolicyIpv6Ipv6Gateway), string tos = default(string), string mask = default(string), RoutePolicyIpv6Ipv6Distance distance = default(RoutePolicyIpv6Ipv6Distance), decimal nexthopNumber = default(decimal), string interface2 = default(string), RoutePolicyIpv6Ipv6Gateway2 gateway2 = default(RoutePolicyIpv6Ipv6Gateway2), string interface3 = default(string), RoutePolicyIpv6Ipv6Gateway3 gateway3 = default(RoutePolicyIpv6Ipv6Gateway3), string interface4 = default(string), RoutePolicyIpv6Ipv6Gateway4 gateway4 = default(RoutePolicyIpv6Ipv6Gateway4), string uuid = default(string), string name = default(string), TypeEnum? type = default(TypeEnum?), decimal priority = default(decimal), bool disableOnInterfaceDown = default(bool), bool vpnPrecedence = default(bool), bool autoAddAccessRules = default(bool), string probe = default(string), bool disableWhenProbesSucceed = default(bool), bool defaultProbeStateUp = default(bool), string comment = default(string), RoutePolicyIpv4Ipv4Ticket ticket = default(RoutePolicyIpv4Ipv4Ticket))
        {
            // to ensure "varInterface" is required (not null)
            if (varInterface == null)
            {
                throw new ArgumentNullException("varInterface is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            ...
            if (source == null)
            {
                throw new ArgumentNullException("source is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Source = source;
            // to ensure "destination" is required (not null)
            if (destination == null)
            {
                throw new ArgumentNullException("destination is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Destination = destination;
            // to ensure "service" is required (not null)
            if (service == null)
            {
                throw new ArgumentNullException("service is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Service = service;
            // to ensure "gateway" is required (not null)
            if (gateway == null)
            {
                throw new ArgumentNullException("gateway is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Gateway = gateway;
            // to ensure "tos" is required (not null)
            if (tos == null)
            {
                throw new ArgumentNullException("tos is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Tos = tos;
            // to ensure "mask" is required (not null)
            if (mask == null)
            {
                throw new ArgumentNullException("mask is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
            this.Mask = mask;
            // to ensure "distance" is required (not null)
            if (distance == null)
            {
                throw new ArgumentNullException("distance is a required property for RoutePolicyIpv6Ipv6 and cannot be null");
            }
        ...
        public RoutePolicyIpv6Ipv6Source Source { get; set; }

        /// <summary>
        /// Gets or Sets Destination
        /// </summary>
        [DataMember(Name = "destination", IsRequired = true, EmitDefaultValue = true)]
        public RoutePolicyIpv6Ipv6Destination Destination { get; set; }
        ...
        public RoutePolicyIpv6Ipv6Service Service { get; set; }

        /// <summary>
        /// Gets or Sets Gateway
        /// </summary>
        [DataMember(Name = "gateway", IsRequired = true, EmitDefaultValue = true)]
        public RoutePolicyIpv6Ipv6Gateway Gateway { get; set; }
        ...
        public RoutePolicyIpv6Ipv6Distance Distance { get; set; }
        ...
        public RoutePolicyIpv6Ipv6Gateway2 Gateway2 { get; set; }
        ...
        public RoutePolicyIpv6Ipv6Gateway3 Gateway3 { get; set; }
        ...
        public RoutePolicyIpv6Ipv6Gateway4 Gateway4 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoutePolicyIpv6Ipv6 {\n");
        ...
        {
            return this.Equals(input as RoutePolicyIpv6Ipv6);
        }

        /// <summary>
        /// Returns true if RoutePolicyIpv6Ipv6 instances are equal
        /// </summary>
        /// <param name="input">Instance of RoutePolicyIpv6Ipv6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoutePolicyIpv6Ipv6 input)
        {
            if (input == null)
            {
                return false;
