...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "log_categories_ipfix")]
    public partial class LogCategoriesIpfix : IEquatable<LogCategoriesIpfix>, IValidatableObject
    {
        /// <summary>
        /// Type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogCategoriesIpfix" /> class.
        /// </summary>
        /// <param name="type">Type..</param>
        /// <param name="redundancyInterval">redundancyInterval.</param>
        public LogCategoriesIpfix(TypeEnum? type = default(TypeEnum?), AppRulePolicyLogRedundancyIntervalInterval redundancyInterval = default(AppRulePolicyLogRedundancyIntervalInterval))
        {
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogCategoriesIpfix {\n");
        ...
        {
            return this.Equals(input as LogCategoriesIpfix);
        }

        /// <summary>
        /// Returns true if LogCategoriesIpfix instances are equal
        /// </summary>
        /// <param name="input">Instance of LogCategoriesIpfix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogCategoriesIpfix input)
        {
            if (input == null)
            {
                return false;
