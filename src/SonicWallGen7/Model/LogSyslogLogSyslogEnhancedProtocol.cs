...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "log_syslog_log_syslog_enhanced_protocol")]
    public partial class LogSyslogLogSyslogEnhancedProtocol : IEquatable<LogSyslogLogSyslogEnhancedProtocol>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogSyslogLogSyslogEnhancedProtocol" /> class.
        /// </summary>
        ...
        public LogSyslogLogSyslogEnhancedProtocol(bool srcIp = default(bool), bool srcNat = default(bool), bool srcPort = default(bool), bool srcNatPort = default(bool), bool dstIp = default(bool), bool dstNat = default(bool), bool dstPort = default(bool), bool dstNatPort = default(bool), bool protocol = default(bool), bool icmpType = default(bool), bool icmpCode = default(bool))
        {
            this.SrcIp = srcIp;
            this.SrcNat = srcNat;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogSyslogLogSyslogEnhancedProtocol {\n");
        ...
        {
            return this.Equals(input as LogSyslogLogSyslogEnhancedProtocol);
        }

        /// <summary>
        /// Returns true if LogSyslogLogSyslogEnhancedProtocol instances are equal
        /// </summary>
        /// <param name="input">Instance of LogSyslogLogSyslogEnhancedProtocol to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogSyslogLogSyslogEnhancedProtocol input)
        {
            if (input == null)
            {
                return false;
