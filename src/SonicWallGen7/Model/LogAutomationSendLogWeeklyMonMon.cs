...
namespace SonicWallGen7.Model
{
    ...
    /// Monday.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_weekly_mon_mon")]
    public partial class LogAutomationSendLogWeeklyMonMon : IEquatable<LogAutomationSendLogWeeklyMonMon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogWeeklyMonMon" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogWeeklyMonMon(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogWeeklyMonMon {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogWeeklyMonMon);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogWeeklyMonMon instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogWeeklyMonMon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogWeeklyMonMon input)
        {
            if (input == null)
            {
                return false;
