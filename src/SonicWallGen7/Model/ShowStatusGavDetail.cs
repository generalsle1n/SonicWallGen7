...
namespace SonicWallGen7.Model
{
    ...
    /// gav detail schema.
    /// </summary>
    [DataContract(Name = "show_status_gav_detail")]
    public partial class ShowStatusGavDetail : IEquatable<ShowStatusGavDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusGavDetail" /> class.
        /// </summary>
        ...
        /// <param name="gatewayAntiVirusExpirationDate">gatewayAntiVirusExpirationDate.</param>
        public ShowStatusGavDetail(string signatureDatabase = default(string), string signatureDatabaseTimestamp = default(string), string lastChecked = default(string), string gatewayAntiVirusExpirationDate = default(string))
        {
            this.SignatureDatabase = signatureDatabase;
            this.SignatureDatabaseTimestamp = signatureDatabaseTimestamp;
            this.LastChecked = lastChecked;
            this.GatewayAntiVirusExpirationDate = gatewayAntiVirusExpirationDate;
        }
        ...
        /// <summary>
        /// Gets or Sets GatewayAntiVirusExpirationDate
        /// </summary>
        [DataMember(Name = "gateway_anti_virus_expiration_date", EmitDefaultValue = false)]
        public string GatewayAntiVirusExpirationDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusGavDetail {\n");
            ...
            sb.Append("  GatewayAntiVirusExpirationDate: ").Append(GatewayAntiVirusExpirationDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowStatusGavDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusGavDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusGavDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusGavDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.GatewayAntiVirusExpirationDate == input.GatewayAntiVirusExpirationDate ||
                    (this.GatewayAntiVirusExpirationDate != null &&
                    this.GatewayAntiVirusExpirationDate.Equals(input.GatewayAntiVirusExpirationDate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.GatewayAntiVirusExpirationDate != null)
                {
                    hashCode = (hashCode * 59) + this.GatewayAntiVirusExpirationDate.GetHashCode();
                }
                return hashCode;
            }
        }
