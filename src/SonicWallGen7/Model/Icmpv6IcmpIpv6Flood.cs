...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "icmpv6_icmp_ipv6_flood")]
    public partial class Icmpv6IcmpIpv6Flood : IEquatable<Icmpv6IcmpIpv6Flood>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Icmpv6IcmpIpv6Flood" /> class.
        /// </summary>
        ...
        public Icmpv6IcmpIpv6Flood(bool protection = default(bool), decimal attackThreshold = default(decimal), decimal blockTimeout = default(decimal), Icmpv6IcmpIpv6FloodProtectedDestList protectedDestList = default(Icmpv6IcmpIpv6FloodProtectedDestList))
        {
        ...
        public Icmpv6IcmpIpv6FloodProtectedDestList ProtectedDestList { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Icmpv6IcmpIpv6Flood {\n");
        ...
        {
            return this.Equals(input as Icmpv6IcmpIpv6Flood);
        }

        /// <summary>
        /// Returns true if Icmpv6IcmpIpv6Flood instances are equal
        /// </summary>
        /// <param name="input">Instance of Icmpv6IcmpIpv6Flood to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Icmpv6IcmpIpv6Flood input)
        {
            if (input == null)
            {
                return false;
