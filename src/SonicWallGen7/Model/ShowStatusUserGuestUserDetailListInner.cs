...
{
    /// <summary>
    /// ShowStatusUserGuestUserDetailListInner
    /// </summary>
    [DataContract(Name = "show_status_user_guest_user_detail_list_inner")]
    public partial class ShowStatusUserGuestUserDetailListInner : IEquatable<ShowStatusUserGuestUserDetailListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusUserGuestUserDetailListInner" /> class.
        /// </summary>
        ...
        public ShowStatusUserGuestUserDetailListInner(string accountName = default(string), string uuid = default(string), string password = default(string), string enabled = default(string), string comment = default(string), string created = default(string), string accountExpires = default(string), string accountLeftLifetime = default(string), string sessionExpires = default(string), string sessionLifetime = default(string), string idleTimeout = default(string), string receiveLimit = default(string), string transmitLimit = default(string), string quotaCycle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusUserGuestUserDetailListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusUserGuestUserDetailListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusUserGuestUserDetailListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusUserGuestUserDetailListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusUserGuestUserDetailListInner input)
        {
            if (input == null)
            {
                return false;
