...
namespace SonicWallGen7.Model
{
    ...
    /// IP version IPv4.
    /// </summary>
    [DataContract(Name = "interface_vlan_ipv4_ipv4")]
    public partial class InterfaceVlanIpv4Ipv4 : IEquatable<InterfaceVlanIpv4Ipv4>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceVlanIpv4Ipv4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InterfaceVlanIpv4Ipv4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceVlanIpv4Ipv4" /> class.
        /// </summary>
        /// <param name="name">Interface name. (required).</param>
        /// <param name="vlan">Interface VLAN ID. (required).</param>
        ...
        public InterfaceVlanIpv4Ipv4(string name = default(string), decimal vlan = default(decimal), InterfaceVlanIpv4Ipv4IpAssignment ipAssignment = default(InterfaceVlanIpv4Ipv4IpAssignment), string comment = default(string), decimal mtu = default(decimal), InterfaceVlanIpv4Ipv4Mac mac = default(InterfaceVlanIpv4Ipv4Mac), InterfaceVlanIpv4Ipv4LinkSpeed linkSpeed = default(InterfaceVlanIpv4Ipv4LinkSpeed), InterfaceIpv4Ipv4Management management = default(InterfaceIpv4Ipv4Management), InterfaceIpv4Ipv4UserLogin userLogin = default(InterfaceIpv4Ipv4UserLogin), bool httpsRedirect = default(bool), bool sendIcmpFragmentation = default(bool), bool fragmentPackets = default(bool), bool ignoreDfBit = default(bool), bool flowReporting = default(bool), bool multicast = default(bool), bool cos8021p = default(bool), bool excludeRoute = default(bool), bool asymmetricRoute = default(bool), bool managementTrafficOnly = default(bool), bool SonicDnsProxy = default(bool), bool shutdownPort = default(bool), InterfaceIpv4Ipv4Secondary secondary = default(InterfaceIpv4Ipv4Secondary), InterfaceIpv4Ipv4Default8021pCos default8021pCos = default(InterfaceIpv4Ipv4Default8021pCos), InterfaceIpv4Ipv4BandwidthManagement bandwidthManagement = default(InterfaceIpv4Ipv4BandwidthManagement), InterfaceVlanIpv4Ipv4RoutedMode routedMode = default(InterfaceVlanIpv4Ipv4RoutedMode))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for InterfaceVlanIpv4Ipv4 and cannot be null");
            }
            this.Name = name;
            this.Vlan = vlan;
        ...
        public InterfaceVlanIpv4Ipv4IpAssignment IpAssignment { get; set; }
        ...
        public InterfaceVlanIpv4Ipv4Mac Mac { get; set; }

        /// <summary>
        /// Gets or Sets LinkSpeed
        /// </summary>
        [DataMember(Name = "link_speed", EmitDefaultValue = false)]
        public InterfaceVlanIpv4Ipv4LinkSpeed LinkSpeed { get; set; }
        ...
        public InterfaceVlanIpv4Ipv4RoutedMode RoutedMode { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InterfaceVlanIpv4Ipv4 {\n");
        ...
        {
            return this.Equals(input as InterfaceVlanIpv4Ipv4);
        }

        /// <summary>
        /// Returns true if InterfaceVlanIpv4Ipv4 instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfaceVlanIpv4Ipv4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfaceVlanIpv4Ipv4 input)
        {
            if (input == null)
            {
                return false;
