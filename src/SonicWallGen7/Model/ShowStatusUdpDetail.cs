...
namespace SonicWallGen7.Model
{
    ...
    /// udp detail schema.
    /// </summary>
    [DataContract(Name = "show_status_udp_detail")]
    public partial class ShowStatusUdpDetail : IEquatable<ShowStatusUdpDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusUdpDetail" /> class.
        /// </summary>
        ...
        public ShowStatusUdpDetail(string connectionsOpened = default(string), string connectionsClosed = default(string), string totalUdpPackets = default(string), string validatedPacketsPassed = default(string), string malformedPacketsDropped = default(string), string averageUdpPacketRate = default(string), string udpFloodsInProgress = default(string), string totalUdpFloodsDetected = default(string), string totalUdpFloodPacketsRejected = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusUdpDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusUdpDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusUdpDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusUdpDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusUdpDetail input)
        {
            if (input == null)
            {
                return false;
