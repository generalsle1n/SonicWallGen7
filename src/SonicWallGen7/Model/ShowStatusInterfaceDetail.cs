...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_interface_detail")]
    public partial class ShowStatusInterfaceDetail : IEquatable<ShowStatusInterfaceDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusInterfaceDetail" /> class.
        /// </summary>
        ...
        public ShowStatusInterfaceDetail(string interfaceName = default(string), string rxUnicastPackets = default(string), string rxBroadcastPackets = default(string), string rxErrors = default(string), string rxBytes = default(string), string txUnicastPackets = default(string), string txBroadcastPackets = default(string), string txErrors = default(string), string txBytes = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusInterfaceDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusInterfaceDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusInterfaceDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusInterfaceDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusInterfaceDetail input)
        {
            if (input == null)
            {
                return false;
