...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_app_flow_server_detail")]
    public partial class ShowStatusAppFlowServerDetail : IEquatable<ShowStatusAppFlowServerDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusAppFlowServerDetail" /> class.
        /// </summary>
        ...
        /// <param name="appServerStartTime">appServerStartTime.</param>
        ...
        public ShowStatusAppFlowServerDetail(string hostName = default(string), string varVersion = default(string), string revision = default(string), string connectionStatus = default(string), string registrationStatus = default(string), string memoryPoolSize = default(string), string dumpPeriod = default(string), string serialExists = default(string), string maxDb = default(string), string serialCount = default(string), string lastSeen = default(string), string lastConfig = default(string), string appServerStartTime = default(string), string recordRate = default(string), string packetRate = default(string), string maxDbFiles = default(string), string currentDbFiles = default(string))
        {
            ...
            this.AppServerStartTime = appServerStartTime;
        ...
        /// <summary>
        /// Gets or Sets AppServerStartTime
        /// </summary>
        [DataMember(Name = "app_server_start_time", EmitDefaultValue = false)]
        public string AppServerStartTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusAppFlowServerDetail {\n");
            ...
            sb.Append("  AppServerStartTime: ").Append(AppServerStartTime).Append("\n");
        ...
        {
            return this.Equals(input as ShowStatusAppFlowServerDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusAppFlowServerDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusAppFlowServerDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusAppFlowServerDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.AppServerStartTime == input.AppServerStartTime ||
                    (this.AppServerStartTime != null &&
                    this.AppServerStartTime.Equals(input.AppServerStartTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AppServerStartTime != null)
                {
                    hashCode = (hashCode * 59) + this.AppServerStartTime.GetHashCode();
                }
