...
{
    /// <summary>
    /// ShowStatusRoutingV4SystemListInner
    /// </summary>
    [DataContract(Name = "show_status_routing_v4_system_list_inner")]
    public partial class ShowStatusRoutingV4SystemListInner : IEquatable<ShowStatusRoutingV4SystemListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusRoutingV4SystemListInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusRoutingV4SystemListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusRoutingV4SystemListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusRoutingV4SystemListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusRoutingV4SystemListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusRoutingV4SystemListInner input)
        {
            if (input == null)
            {
                return false;
