...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "log_viewpoint_syslog_servers")]
    public partial class LogViewpointSyslogServers : IEquatable<LogViewpointSyslogServers>, IValidatableObject
    {
        /// <summary>
        /// Syslog server type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogViewpointSyslogServers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LogViewpointSyslogServers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LogViewpointSyslogServers" /> class.
        /// </summary>
        ...
        public LogViewpointSyslogServers(LogSyslogServersAddress address = default(LogSyslogServersAddress), decimal? port = default(decimal?), decimal? profile = default(decimal?), TypeEnum? type = default(TypeEnum?), FacilityEnum? facility = default(FacilityEnum?), FormatEnum? format = default(FormatEnum?), string id = default(string), bool enabled = default(bool), LogSyslogServersEventRateLimiting eventRateLimiting = default(LogSyslogServersEventRateLimiting), LogSyslogServersDataRateLimiting dataRateLimiting = default(LogSyslogServersDataRateLimiting), string outboundInterface = default(string), string localInterface = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for LogViewpointSyslogServers and cannot be null");
            }
            this.Address = address;
            // to ensure "port" is required (not null)
            if (port == null)
            {
                throw new ArgumentNullException("port is a required property for LogViewpointSyslogServers and cannot be null");
            }
            this.Port = port;
            // to ensure "profile" is required (not null)
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for LogViewpointSyslogServers and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogViewpointSyslogServers {\n");
        ...
        {
            return this.Equals(input as LogViewpointSyslogServers);
        }

        /// <summary>
        /// Returns true if LogViewpointSyslogServers instances are equal
        /// </summary>
        /// <param name="input">Instance of LogViewpointSyslogServers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogViewpointSyslogServers input)
        {
            if (input == null)
            {
                return false;
