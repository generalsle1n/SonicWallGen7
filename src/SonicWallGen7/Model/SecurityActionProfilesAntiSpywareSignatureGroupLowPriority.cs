...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "security_action_profiles_anti_spyware_signature_group_low_priority")]
    public partial class SecurityActionProfilesAntiSpywareSignatureGroupLowPriority : IEquatable<SecurityActionProfilesAntiSpywareSignatureGroupLowPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityActionProfilesAntiSpywareSignatureGroupLowPriority" /> class.
        /// </summary>
        ...
        public SecurityActionProfilesAntiSpywareSignatureGroupLowPriority(bool prevent = default(bool), bool packetMonitor = default(bool), bool log = default(bool), decimal logRedundancy = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityActionProfilesAntiSpywareSignatureGroupLowPriority {\n");
        ...
        {
            return this.Equals(input as SecurityActionProfilesAntiSpywareSignatureGroupLowPriority);
        }

        /// <summary>
        /// Returns true if SecurityActionProfilesAntiSpywareSignatureGroupLowPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityActionProfilesAntiSpywareSignatureGroupLowPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityActionProfilesAntiSpywareSignatureGroupLowPriority input)
        {
            if (input == null)
            {
                return false;
