...
namespace SonicWallGen7.Model
{
    ...
    /// Sunday.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_weekly_sun_sun")]
    public partial class LogAutomationSendLogWeeklySunSun : IEquatable<LogAutomationSendLogWeeklySunSun>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogWeeklySunSun" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogWeeklySunSun(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogWeeklySunSun {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogWeeklySunSun);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogWeeklySunSun instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogWeeklySunSun to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogWeeklySunSun input)
        {
            if (input == null)
            {
                return false;
