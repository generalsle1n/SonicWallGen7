...
namespace SonicWallGen7.Model
{
    ...
    public partial class DnsSecuritySinkholeCustomMaliciousEntryCollectionDnsSecurityDnsSinkhole : IEquatable<DnsSecuritySinkholeCustomMaliciousEntryCollectionDnsSecurityDnsSinkhole>, IValidatableObject
    {
        ...
        public bool Equals(DnsSecuritySinkholeCustomMaliciousEntryCollectionDnsSecurityDnsSinkhole input)
        {
            ...
            return 
                (
                    this.CustomMaliciousEntry == input.CustomMaliciousEntry ||
                    this.CustomMaliciousEntry != null &&
                    input.CustomMaliciousEntry != null &&
                    this.CustomMaliciousEntry.SequenceEqual(input.CustomMaliciousEntry)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CustomMaliciousEntry != null)
                {
                    hashCode = (hashCode * 59) + this.CustomMaliciousEntry.GetHashCode();
                }
                return hashCode;
            }
        }
