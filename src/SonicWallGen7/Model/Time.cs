...
namespace SonicWallGen7.Model
{
    ...
    public partial class Time : IEquatable<Time>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varTime">varTime.</param>
        public Time(TimeTime varTime = default(TimeTime))
        {
            this.VarTime = varTime;
        }

        /// <summary>
        /// Gets or Sets VarTime
        /// </summary>
        [DataMember(Name = "time", EmitDefaultValue = false)]
        public TimeTime VarTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VarTime: ").Append(VarTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Time input)
        {
            ...
            return 
                (
                    this.VarTime == input.VarTime ||
                    (this.VarTime != null &&
                    this.VarTime.Equals(input.VarTime))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.VarTime.GetHashCode();
                }
                return hashCode;
            }
        }
