...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dns_split_entry_server_ipv6")]
    public partial class DnsSplitEntryServerIpv6 : IEquatable<DnsSplitEntryServerIpv6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DnsSplitEntryServerIpv6" /> class.
        /// </summary>
        /// <param name="primary">primary.</param>
        /// <param name="secondary">secondary.</param>
        /// <param name="tertiary">tertiary.</param>
        public DnsSplitEntryServerIpv6(DnsSplitEntryServerIpv4Primary primary = default(DnsSplitEntryServerIpv4Primary), DnsSplitEntryServerIpv4Secondary secondary = default(DnsSplitEntryServerIpv4Secondary), DnsSplitEntryServerIpv4Tertiary tertiary = default(DnsSplitEntryServerIpv4Tertiary))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DnsSplitEntryServerIpv6 {\n");
        ...
        {
            return this.Equals(input as DnsSplitEntryServerIpv6);
        }

        /// <summary>
        /// Returns true if DnsSplitEntryServerIpv6 instances are equal
        /// </summary>
        /// <param name="input">Instance of DnsSplitEntryServerIpv6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DnsSplitEntryServerIpv6 input)
        {
            if (input == null)
            {
                return false;
