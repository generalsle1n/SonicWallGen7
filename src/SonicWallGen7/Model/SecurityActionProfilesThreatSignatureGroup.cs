...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "security_action_profiles_threat_signature_group")]
    public partial class SecurityActionProfilesThreatSignatureGroup : IEquatable<SecurityActionProfilesThreatSignatureGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityActionProfilesThreatSignatureGroup" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityActionProfilesThreatSignatureGroup {\n");
        ...
        {
            return this.Equals(input as SecurityActionProfilesThreatSignatureGroup);
        }

        /// <summary>
        /// Returns true if SecurityActionProfilesThreatSignatureGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityActionProfilesThreatSignatureGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityActionProfilesThreatSignatureGroup input)
        {
            if (input == null)
            {
                return false;
