...
{
    /// <summary>
    /// ShowStatusFlbStatisticsListInner
    /// </summary>
    [DataContract(Name = "show_status_flb_statistics_list_inner")]
    public partial class ShowStatusFlbStatisticsListInner : IEquatable<ShowStatusFlbStatisticsListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusFlbStatisticsListInner" /> class.
        /// </summary>
        ...
        public ShowStatusFlbStatisticsListInner(string groupName = default(string), string memberName = default(string), string totalConnection = default(string), string newConnection = default(string), string configuredRatio = default(string), string averageRatio = default(string), string currentRatio = default(string), string totalUnicastBytes = default(string), string rxUnicast = default(string), string rxBytes = default(string), string txUnicast = default(string), string txBytes = default(string), string thoughputKbitsS = default(string), string thoughputKbS = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusFlbStatisticsListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusFlbStatisticsListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusFlbStatisticsListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusFlbStatisticsListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusFlbStatisticsListInner input)
        {
            if (input == null)
            {
                return false;
