...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "policies_setting_base_policies_setting_antivirus_profile_for_zone")]
    public partial class PoliciesSettingBasePoliciesSettingAntivirusProfileForZone : IEquatable<PoliciesSettingBasePoliciesSettingAntivirusProfileForZone>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoliciesSettingBasePoliciesSettingAntivirusProfileForZone" /> class.
        /// </summary>
        ...
        public PoliciesSettingBasePoliciesSettingAntivirusProfileForZone(bool cloud = default(bool), bool inbound = default(bool), bool outbound = default(bool), bool prevent = default(bool), bool packetMonitor = default(bool), PoliciesSettingBasePoliciesSettingAntivirusProfileForZoneLog log = default(PoliciesSettingBasePoliciesSettingAntivirusProfileForZoneLog), bool passwordProtectedZip = default(bool), bool msOfficeMacros = default(bool), bool packedExecutables = default(bool), bool smtpResponses = default(bool), bool eicarDetection = default(bool), bool httpByteRange = default(bool), bool ftpRest = default(bool), bool scanHighCompression = default(bool))
        {
            this.Cloud = cloud;
        ...
        public PoliciesSettingBasePoliciesSettingAntivirusProfileForZoneLog Log { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoliciesSettingBasePoliciesSettingAntivirusProfileForZone {\n");
        ...
        {
            return this.Equals(input as PoliciesSettingBasePoliciesSettingAntivirusProfileForZone);
        }

        /// <summary>
        /// Returns true if PoliciesSettingBasePoliciesSettingAntivirusProfileForZone instances are equal
        /// </summary>
        /// <param name="input">Instance of PoliciesSettingBasePoliciesSettingAntivirusProfileForZone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoliciesSettingBasePoliciesSettingAntivirusProfileForZone input)
        {
            if (input == null)
            {
                return false;
