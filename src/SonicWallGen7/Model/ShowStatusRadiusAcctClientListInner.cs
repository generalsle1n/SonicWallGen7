...
{
    /// <summary>
    /// ShowStatusRadiusAcctClientListInner
    /// </summary>
    [DataContract(Name = "show_status_radius_acct_client_list_inner")]
    public partial class ShowStatusRadiusAcctClientListInner : IEquatable<ShowStatusRadiusAcctClientListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusRadiusAcctClientListInner" /> class.
        /// </summary>
        ...
        public ShowStatusRadiusAcctClientListInner(string varClient = default(string), string ipAddress = default(string), string status = default(string), string timeIdleSeconds = default(string), string totalAccountingRequests = default(string), string goodAccountingRequests = default(string), string badAccountingRequests = default(string), string nonAccountingRequestsReceivedDropped = default(string), string startUserRequestsRcvd = default(string), string stopUserRequestsReceived = default(string), string proxyForwardingRequestsSent = default(string), string proxyForwardingRequestsResponsesRcvd = default(string), string proxyForwardingResponseErrors = default(string), string proxyForwardingResponseTimeouts = default(string), string responseTimeToProxyForwardedRqstAvg = default(string), string responseTimeToProxyForwardedRqstMax = default(string), string startUserRequestsRepeats = default(string), string startUserRequestsErrors = default(string), string stopUserRequestsErrors = default(string), string successfulUserLogins = default(string), string failedUserLogins = default(string), string userLogouts = default(string), string userNotFoundErrorsWithStopUser = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusRadiusAcctClientListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusRadiusAcctClientListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusRadiusAcctClientListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusRadiusAcctClientListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusRadiusAcctClientListInner input)
        {
            if (input == null)
            {
                return false;
