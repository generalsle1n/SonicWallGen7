...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ssl_vpn_bookmark_service")]
    public partial class SslVpnBookmarkService : IEquatable<SslVpnBookmarkService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SslVpnBookmarkService" /> class.
        /// </summary>
        /// <param name="rdp">rdp.</param>
        /// <param name="vnc">vnc.</param>
        /// <param name="telnet">telnet.</param>
        /// <param name="sshv2">sshv2.</param>
        public SslVpnBookmarkService(SslVpnBookmarkServiceRdp rdp = default(SslVpnBookmarkServiceRdp), UserLocalGroupBookmarkInnerServiceVnc vnc = default(UserLocalGroupBookmarkInnerServiceVnc), UserLocalGroupBookmarkInnerServiceTelnet telnet = default(UserLocalGroupBookmarkInnerServiceTelnet), UserLocalGroupBookmarkInnerServiceSshv2 sshv2 = default(UserLocalGroupBookmarkInnerServiceSshv2))
        {
            this.Rdp = rdp;
            this.Vnc = vnc;
            this.Telnet = telnet;
        ...
        public SslVpnBookmarkServiceRdp Rdp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SslVpnBookmarkService {\n");
        ...
        {
            return this.Equals(input as SslVpnBookmarkService);
        }

        /// <summary>
        /// Returns true if SslVpnBookmarkService instances are equal
        /// </summary>
        /// <param name="input">Instance of SslVpnBookmarkService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SslVpnBookmarkService input)
        {
            if (input == null)
            {
                return false;
