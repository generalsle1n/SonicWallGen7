...
namespace SonicWallGen7.Model
{
    ...
    /// Tuesday.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_weekly_tue_tue")]
    public partial class LogAutomationSendLogWeeklyTueTue : IEquatable<LogAutomationSendLogWeeklyTueTue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogWeeklyTueTue" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogWeeklyTueTue(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogWeeklyTueTue {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogWeeklyTueTue);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogWeeklyTueTue instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogWeeklyTueTue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogWeeklyTueTue input)
        {
            if (input == null)
            {
                return false;
