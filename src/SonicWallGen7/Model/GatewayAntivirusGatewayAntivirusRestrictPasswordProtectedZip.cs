...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gateway_antivirus_gateway_antivirus_restrict_password_protected_zip")]
    public partial class GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip : IEquatable<GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip" /> class.
        /// </summary>
        ...
        public GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip(bool http = default(bool), bool ftp = default(bool), bool imap = default(bool), bool smtp = default(bool), bool pop3 = default(bool), bool cifsNetbios = default(bool))
        {
            this.Http = http;
            this.Ftp = ftp;
            this.Imap = imap;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip {\n");
        ...
        {
            return this.Equals(input as GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip);
        }

        /// <summary>
        /// Returns true if GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayAntivirusGatewayAntivirusRestrictPasswordProtectedZip input)
        {
            if (input == null)
            {
                return false;
