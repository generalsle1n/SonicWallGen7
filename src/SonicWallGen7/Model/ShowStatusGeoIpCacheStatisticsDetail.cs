...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_geo_ip_cache_statistics_detail")]
    public partial class ShowStatusGeoIpCacheStatisticsDetail : IEquatable<ShowStatusGeoIpCacheStatisticsDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusGeoIpCacheStatisticsDetail" /> class.
        /// </summary>
        ...
        /// <param name="locationMapCount">locationMapCount.</param>
        public ShowStatusGeoIpCacheStatisticsDetail(string locationServerIp = default(string), string resolvedEntries = default(string), string unresolvedEntries = default(string), string currentEntryCount = default(string), string maxEntryCount = default(string), string locationMapCount = default(string))
        {
            ...
            this.LocationMapCount = locationMapCount;
        }
        ...
        /// <summary>
        /// Gets or Sets LocationMapCount
        /// </summary>
        [DataMember(Name = "location_map_count", EmitDefaultValue = false)]
        public string LocationMapCount { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusGeoIpCacheStatisticsDetail {\n");
            ...
            sb.Append("  LocationMapCount: ").Append(LocationMapCount).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ShowStatusGeoIpCacheStatisticsDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusGeoIpCacheStatisticsDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusGeoIpCacheStatisticsDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusGeoIpCacheStatisticsDetail input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.LocationMapCount == input.LocationMapCount ||
                    (this.LocationMapCount != null &&
                    this.LocationMapCount.Equals(input.LocationMapCount))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LocationMapCount != null)
                {
                    hashCode = (hashCode * 59) + this.LocationMapCount.GetHashCode();
                }
                return hashCode;
            }
        }
