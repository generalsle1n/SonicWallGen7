...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "appflow_gmsflow_server_appflow_gmsflow_server")]
    public partial class AppflowGmsflowServerAppflowGmsflowServer : IEquatable<AppflowGmsflowServerAppflowGmsflowServer>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Select Advanced GMS flow server configuration mode.
        /// </summary>
        /// <value>Select Advanced GMS flow server configuration mode.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppflowGmsflowServerAppflowGmsflowServer" /> class.
        /// </summary>
        /// <param name="flows">Enable sending appflow to SonicWALL GMS flow server..</param>
        /// <param name="realTime">Enable sending of real-time data to SonicWALL GMS flow server..</param>
        /// <param name="systemLogs">Enable sending system logs to SonicWALL GMS flow server..</param>
        ...
        /// <param name="autoSynchronize">Enable auto-synchronize for GMS flow server..</param>
        /// <param name="advancedMode">Select Advanced GMS flow server configuration mode..</param>
        ...
        public AppflowGmsflowServerAppflowGmsflowServer(bool flows = default(bool), bool realTime = default(bool), bool systemLogs = default(bool), AppflowGmsflowServerAppflowGmsflowServerReport report = default(AppflowGmsflowServerAppflowGmsflowServerReport), ReportingFormatEnum? reportingFormat = default(ReportingFormatEnum?), AppflowGmsflowServerAppflowGmsflowServerDynamicFlows dynamicFlows = default(AppflowGmsflowServerAppflowGmsflowServerDynamicFlows), ModeEnum? mode = default(ModeEnum?), bool autoSynchronize = default(bool), AdvancedModeEnum? advancedMode = default(AdvancedModeEnum?), LoadBalancingModeEnum? loadBalancingMode = default(LoadBalancingModeEnum?), AppflowGmsflowServerAppflowGmsflowServerServerIp serverIp = default(AppflowGmsflowServerAppflowGmsflowServerServerIp), AppflowGmsflowServerAppflowGmsflowServerServer2Ip server2Ip = default(AppflowGmsflowServerAppflowGmsflowServerServer2Ip))
        {
            this.Flows = flows;
        ...
        /// <summary>
        /// Enable sending appflow to SonicWALL GMS flow server.
        /// </summary>
        /// <value>Enable sending appflow to SonicWALL GMS flow server.</value>
        [DataMember(Name = "flows", EmitDefaultValue = true)]
        public bool Flows { get; set; }

        /// <summary>
        /// Enable sending of real-time data to SonicWALL GMS flow server.
        /// </summary>
        /// <value>Enable sending of real-time data to SonicWALL GMS flow server.</value>
        [DataMember(Name = "real_time", EmitDefaultValue = true)]
        public bool RealTime { get; set; }

        /// <summary>
        /// Enable sending system logs to SonicWALL GMS flow server.
        /// </summary>
        /// <value>Enable sending system logs to SonicWALL GMS flow server.</value>
        ...
        /// <summary>
        /// Enable auto-synchronize for GMS flow server.
        /// </summary>
        /// <value>Enable auto-synchronize for GMS flow server.</value>
        ...
        public AppflowGmsflowServerAppflowGmsflowServerServerIp ServerIp { get; set; }

        /// <summary>
        /// Gets or Sets Server2Ip
        /// </summary>
        [DataMember(Name = "server_2_ip", EmitDefaultValue = false)]
        public AppflowGmsflowServerAppflowGmsflowServerServer2Ip Server2Ip { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppflowGmsflowServerAppflowGmsflowServer {\n");
        ...
        {
            return this.Equals(input as AppflowGmsflowServerAppflowGmsflowServer);
        }

        /// <summary>
        /// Returns true if AppflowGmsflowServerAppflowGmsflowServer instances are equal
        /// </summary>
        /// <param name="input">Instance of AppflowGmsflowServerAppflowGmsflowServer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppflowGmsflowServerAppflowGmsflowServer input)
        {
            if (input == null)
            {
                return false;
