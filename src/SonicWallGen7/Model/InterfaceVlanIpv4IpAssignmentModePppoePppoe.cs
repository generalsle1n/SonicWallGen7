...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interface_vlan_ipv4_ip_assignment_mode_pppoe_pppoe")]
    public partial class InterfaceVlanIpv4IpAssignmentModePppoePppoe : IEquatable<InterfaceVlanIpv4IpAssignmentModePppoePppoe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceVlanIpv4IpAssignmentModePppoePppoe" /> class.
        /// </summary>
        ...
        public InterfaceVlanIpv4IpAssignmentModePppoePppoe(bool dynamic = default(bool), string unnumbered = default(string), decimal inactivity = default(decimal), string ip = default(string), bool lcpEchoPackets = default(bool), string password = default(string), string serviceName = default(string), decimal reconnect = default(decimal), string userName = default(string), decimal ncpNegRetrans = default(decimal), InterfaceVlanIpv4IpAssignmentModePppoePppoeSchedule schedule = default(InterfaceVlanIpv4IpAssignmentModePppoePppoeSchedule))
        {
        ...
        public InterfaceVlanIpv4IpAssignmentModePppoePppoeSchedule Schedule { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InterfaceVlanIpv4IpAssignmentModePppoePppoe {\n");
        ...
        {
            return this.Equals(input as InterfaceVlanIpv4IpAssignmentModePppoePppoe);
        }

        /// <summary>
        /// Returns true if InterfaceVlanIpv4IpAssignmentModePppoePppoe instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfaceVlanIpv4IpAssignmentModePppoePppoe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfaceVlanIpv4IpAssignmentModePppoePppoe input)
        {
            if (input == null)
            {
                return false;
