...
namespace SonicWallGen7.Model
{
    ...
    public partial class SonicDnsSecuritySinkholeSonicDnsSinkholeActionTypeDroppingWithLogs : IEquatable<SonicDnsSecuritySinkholeSonicDnsSinkholeActionTypeDroppingWithLogs>, IValidatableObject
    {
        ...
        /// Dropping, with Logs
        /// </summary>
        /// <value>Dropping, with Logs</value>
        [DataMember(Name = "dropping_with_logs", EmitDefaultValue = true)]
        public bool DroppingWithLogs { get; set; }
        ...
        public bool Equals(SonicDnsSecuritySinkholeSonicDnsSinkholeActionTypeDroppingWithLogs input)
        {
            ...
            return 
                (
                    this.DroppingWithLogs == input.DroppingWithLogs ||
                    this.DroppingWithLogs.Equals(input.DroppingWithLogs)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = (hashCode * 59) + this.DroppingWithLogs.GetHashCode();
                return hashCode;
            }
        }
