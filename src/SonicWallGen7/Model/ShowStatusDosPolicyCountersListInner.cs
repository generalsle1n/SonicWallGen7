...
{
    /// <summary>
    /// ShowStatusDosPolicyCountersListInner
    /// </summary>
    [DataContract(Name = "show_status_dos_policy_counters_list_inner")]
    public partial class ShowStatusDosPolicyCountersListInner : IEquatable<ShowStatusDosPolicyCountersListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusDosPolicyCountersListInner" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets TotalPackets
        /// </summary>
        [DataMember(Name = "totalPackets", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusDosPolicyCountersListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusDosPolicyCountersListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusDosPolicyCountersListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusDosPolicyCountersListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusDosPolicyCountersListInner input)
        {
            if (input == null)
            {
                return false;
