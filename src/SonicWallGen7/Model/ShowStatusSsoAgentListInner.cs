...
{
    /// <summary>
    /// ShowStatusSsoAgentListInner
    /// </summary>
    [DataContract(Name = "show_status_sso_agent_list_inner")]
    public partial class ShowStatusSsoAgentListInner : IEquatable<ShowStatusSsoAgentListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusSsoAgentListInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusSsoAgentListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusSsoAgentListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusSsoAgentListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusSsoAgentListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusSsoAgentListInner input)
        {
            if (input == null)
            {
                return false;
