...
namespace SonicWallGen7.Model
{
    ...
    /// IPV4 address group.
    /// </summary>
    [DataContract(Name = "address_group_ipv4_ipv4")]
    public partial class AddressGroupIpv4Ipv4 : IEquatable<AddressGroupIpv4Ipv4>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressGroupIpv4Ipv4" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressGroupIpv4Ipv4() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressGroupIpv4Ipv4" /> class.
        /// </summary>
        ...
        public AddressGroupIpv4Ipv4(string name = default(string), AddressGroupIpv4Ipv4AddressGroup addressGroup = default(AddressGroupIpv4Ipv4AddressGroup), AddressGroupIpv4Ipv4AddressObject addressObject = default(AddressGroupIpv4Ipv4AddressObject))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AddressGroupIpv4Ipv4 and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressGroupIpv4Ipv4 {\n");
        ...
        {
            return this.Equals(input as AddressGroupIpv4Ipv4);
        }

        /// <summary>
        /// Returns true if AddressGroupIpv4Ipv4 instances are equal
        /// </summary>
        /// <param name="input">Instance of AddressGroupIpv4Ipv4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddressGroupIpv4Ipv4 input)
        {
            if (input == null)
            {
                return false;
