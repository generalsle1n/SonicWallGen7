...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "appflow_sfr_mailing_test_email_appflow_sfr_mailing_test_email")]
    public partial class AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail : IEquatable<AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail" /> class.
        /// </summary>
        ...
        public AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail(bool sendEmail = default(bool), string smtpServerHost = default(string), string reportToEmail = default(string), string reportFromEmail = default(string), decimal smtpServerPort = default(decimal), SecurityMethodEnum? securityMethod = default(SecurityMethodEnum?), bool smtpAuth = default(bool), string smtpUser = default(string), string smtpPass = default(string), bool popBeforeSmtp = default(bool), string popServerAddress = default(string), string popUsername = default(string), string popPass = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail {\n");
        ...
        {
            return this.Equals(input as AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail);
        }

        /// <summary>
        /// Returns true if AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail instances are equal
        /// </summary>
        /// <param name="input">Instance of AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppflowSfrMailingTestEmailAppflowSfrMailingTestEmail input)
        {
            if (input == null)
            {
                return false;
