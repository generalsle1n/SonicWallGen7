...
{
    /// <summary>
    /// ShowStatusFlbGroupStatusListInner
    /// </summary>
    [DataContract(Name = "show_status_flb_group_status_list_inner")]
    public partial class ShowStatusFlbGroupStatusListInner : IEquatable<ShowStatusFlbGroupStatusListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusFlbGroupStatusListInner" /> class.
        /// </summary>
        ...
        public ShowStatusFlbGroupStatusListInner(string groupName = default(string), string type = default(string), string status = default(string), string totalMembers = default(string), string primaryMember = default(string), string activeMember = default(string), string loadBalancingMember = default(string), string finalBackUp = default(string), string globalProbing = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusFlbGroupStatusListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusFlbGroupStatusListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusFlbGroupStatusListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusFlbGroupStatusListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusFlbGroupStatusListInner input)
        {
            if (input == null)
            {
                return false;
