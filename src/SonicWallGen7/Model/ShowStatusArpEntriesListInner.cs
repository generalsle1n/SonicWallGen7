...
{
    /// <summary>
    /// ShowStatusArpEntriesListInner
    /// </summary>
    [DataContract(Name = "show_status_arp_entries_list_inner")]
    public partial class ShowStatusArpEntriesListInner : IEquatable<ShowStatusArpEntriesListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusArpEntriesListInner" /> class.
        /// </summary>
        ...
        /// <param name="bindMac">bindMac.</param>
        public ShowStatusArpEntriesListInner(string ip = default(string), string mac = default(string), string vendor = default(string), string varInterface = default(string), string publish = default(string), string bindMac = default(string))
        {
            this.Ip = ip;
            this.Mac = mac;
            this.Vendor = vendor;
        ...
        /// <summary>
        /// Gets or Sets BindMac
        /// </summary>
        [DataMember(Name = "bind_mac", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusArpEntriesListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusArpEntriesListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusArpEntriesListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusArpEntriesListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusArpEntriesListInner input)
        {
            if (input == null)
            {
                return false;
