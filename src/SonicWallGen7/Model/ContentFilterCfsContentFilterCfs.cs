...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "content_filter_cfs_content_filter_cfs")]
    public partial class ContentFilterCfsContentFilterCfs : IEquatable<ContentFilterCfsContentFilterCfs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentFilterCfsContentFilterCfs" /> class.
        /// </summary>
        ...
        public ContentFilterCfsContentFilterCfs(decimal maxUrlCaches = default(decimal), bool enable = default(bool), bool blockIfServerUnavailable = default(bool), decimal serverTimeout = default(decimal), ContentFilterCfsContentFilterCfsLocalServer localServer = default(ContentFilterCfsContentFilterCfsLocalServer), ContentFilterCfsContentFilterCfsExclude exclude = default(ContentFilterCfsContentFilterCfsExclude))
        {
        ...
        public ContentFilterCfsContentFilterCfsExclude Exclude { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentFilterCfsContentFilterCfs {\n");
        ...
        {
            return this.Equals(input as ContentFilterCfsContentFilterCfs);
        }

        /// <summary>
        /// Returns true if ContentFilterCfsContentFilterCfs instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentFilterCfsContentFilterCfs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentFilterCfsContentFilterCfs input)
        {
            if (input == null)
            {
                return false;
