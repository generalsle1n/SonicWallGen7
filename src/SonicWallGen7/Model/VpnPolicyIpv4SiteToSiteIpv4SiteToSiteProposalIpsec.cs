...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "vpn_policy_ipv4_site_to_site_ipv4_site_to_site_proposal_ipsec")]
    public partial class VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec : IEquatable<VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec>, IValidatableObject
    {
        /// <summary>
        /// Protocol.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec" /> class.
        /// </summary>
        ...
        public VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec(ProtocolEnum? protocol = default(ProtocolEnum?), VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecEncryption encryption = default(VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecEncryption), VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecAuthentication authentication = default(VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecAuthentication), VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecPerfectForwardSecrecy perfectForwardSecrecy = default(VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecPerfectForwardSecrecy), decimal lifetime = default(decimal), decimal lifebytes = default(decimal), string inSpi = default(string), string outSpi = default(string), string encryptionKey = default(string), string authenticationKey = default(string))
        {
        ...
        public VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecEncryption Encryption { get; set; }

        /// <summary>
        /// Gets or Sets Authentication
        /// </summary>
        [DataMember(Name = "authentication", EmitDefaultValue = false)]
        public VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsecAuthentication Authentication { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec {\n");
        ...
        {
            return this.Equals(input as VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec);
        }

        /// <summary>
        /// Returns true if VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec instances are equal
        /// </summary>
        /// <param name="input">Instance of VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VpnPolicyIpv4SiteToSiteIpv4SiteToSiteProposalIpsec input)
        {
            if (input == null)
            {
                return false;
