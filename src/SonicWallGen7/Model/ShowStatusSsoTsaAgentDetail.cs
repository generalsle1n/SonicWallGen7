...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_sso_tsa_agent_detail")]
    public partial class ShowStatusSsoTsaAgentDetail : IEquatable<ShowStatusSsoTsaAgentDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusSsoTsaAgentDetail" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusSsoTsaAgentDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusSsoTsaAgentDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusSsoTsaAgentDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusSsoTsaAgentDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusSsoTsaAgentDetail input)
        {
            if (input == null)
            {
                return false;
