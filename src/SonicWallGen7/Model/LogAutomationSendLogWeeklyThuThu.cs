...
namespace SonicWallGen7.Model
{
    ...
    /// Thursday.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_weekly_thu_thu")]
    public partial class LogAutomationSendLogWeeklyThuThu : IEquatable<LogAutomationSendLogWeeklyThuThu>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogWeeklyThuThu" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogWeeklyThuThu(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogWeeklyThuThu {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogWeeklyThuThu);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogWeeklyThuThu instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogWeeklyThuThu to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogWeeklyThuThu input)
        {
            if (input == null)
            {
                return false;
