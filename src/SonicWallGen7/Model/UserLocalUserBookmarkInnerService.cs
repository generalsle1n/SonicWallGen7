...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user_local_user_bookmark_inner_service")]
    public partial class UserLocalUserBookmarkInnerService : IEquatable<UserLocalUserBookmarkInnerService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLocalUserBookmarkInnerService" /> class.
        /// </summary>
        /// <param name="rdp">rdp.</param>
        /// <param name="vnc">vnc.</param>
        /// <param name="telnet">telnet.</param>
        /// <param name="sshv2">sshv2.</param>
        public UserLocalUserBookmarkInnerService(UserLocalUserBookmarkInnerServiceRdp rdp = default(UserLocalUserBookmarkInnerServiceRdp), UserLocalGroupBookmarkInnerServiceVnc vnc = default(UserLocalGroupBookmarkInnerServiceVnc), UserLocalGroupBookmarkInnerServiceTelnet telnet = default(UserLocalGroupBookmarkInnerServiceTelnet), UserLocalGroupBookmarkInnerServiceSshv2 sshv2 = default(UserLocalGroupBookmarkInnerServiceSshv2))
        {
            this.Rdp = rdp;
            this.Vnc = vnc;
            this.Telnet = telnet;
        ...
        public UserLocalUserBookmarkInnerServiceRdp Rdp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserLocalUserBookmarkInnerService {\n");
        ...
        {
            return this.Equals(input as UserLocalUserBookmarkInnerService);
        }

        /// <summary>
        /// Returns true if UserLocalUserBookmarkInnerService instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLocalUserBookmarkInnerService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLocalUserBookmarkInnerService input)
        {
            if (input == null)
            {
                return false;
