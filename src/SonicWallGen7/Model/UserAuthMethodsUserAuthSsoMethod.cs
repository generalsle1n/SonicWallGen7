...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user_auth_methods_user_auth_sso_method")]
    public partial class UserAuthMethodsUserAuthSsoMethod : IEquatable<UserAuthMethodsUserAuthSsoMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAuthMethodsUserAuthSsoMethod" /> class.
        /// </summary>
        ...
        public UserAuthMethodsUserAuthSsoMethod(bool ssoAgent = default(bool), bool terminalServicesAgent = default(bool), UserAuthMethodsUserAuthSsoMethodBrowserNtlm browserNtlm = default(UserAuthMethodsUserAuthSsoMethodBrowserNtlm), bool radiusAccounting = default(bool), bool thirdPartyApi = default(bool), bool captureClient = default(bool))
        {
        ...
        public UserAuthMethodsUserAuthSsoMethodBrowserNtlm BrowserNtlm { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAuthMethodsUserAuthSsoMethod {\n");
        ...
        {
            return this.Equals(input as UserAuthMethodsUserAuthSsoMethod);
        }

        /// <summary>
        /// Returns true if UserAuthMethodsUserAuthSsoMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of UserAuthMethodsUserAuthSsoMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAuthMethodsUserAuthSsoMethod input)
        {
            if (input == null)
            {
                return false;
