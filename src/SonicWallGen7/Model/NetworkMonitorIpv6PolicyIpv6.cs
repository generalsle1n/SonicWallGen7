...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "network_monitor_ipv6_policy_ipv6")]
    public partial class NetworkMonitorIpv6PolicyIpv6 : IEquatable<NetworkMonitorIpv6PolicyIpv6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkMonitorIpv6PolicyIpv6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NetworkMonitorIpv6PolicyIpv6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkMonitorIpv6PolicyIpv6" /> class.
        /// </summary>
        ...
        public NetworkMonitorIpv6PolicyIpv6(string name = default(string), NetworkMonitorIpv6PolicyIpv6Probe probe = default(NetworkMonitorIpv6PolicyIpv6Probe), string outboundInterface = default(string), NetworkMonitorIpv6PolicyIpv6NextHop nextHop = default(NetworkMonitorIpv6PolicyIpv6NextHop), NetworkMonitorIpv6PolicyIpv6LocalIp localIp = default(NetworkMonitorIpv6PolicyIpv6LocalIp), decimal replyTimeout = default(decimal), NetworkMonitorIpv4PolicyIpv4Interval interval = default(NetworkMonitorIpv4PolicyIpv4Interval), bool mustRespond = default(bool), bool rstAsMiss = default(bool), string comment = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for NetworkMonitorIpv6PolicyIpv6 and cannot be null");
            }
            this.Name = name;
            this.Probe = probe;
        ...
        public NetworkMonitorIpv6PolicyIpv6Probe Probe { get; set; }
        ...
        public NetworkMonitorIpv6PolicyIpv6NextHop NextHop { get; set; }

        /// <summary>
        /// Gets or Sets LocalIp
        /// </summary>
        [DataMember(Name = "local_ip", EmitDefaultValue = false)]
        public NetworkMonitorIpv6PolicyIpv6LocalIp LocalIp { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetworkMonitorIpv6PolicyIpv6 {\n");
        ...
        {
            return this.Equals(input as NetworkMonitorIpv6PolicyIpv6);
        }

        /// <summary>
        /// Returns true if NetworkMonitorIpv6PolicyIpv6 instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkMonitorIpv6PolicyIpv6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkMonitorIpv6PolicyIpv6 input)
        {
            if (input == null)
            {
                return false;
