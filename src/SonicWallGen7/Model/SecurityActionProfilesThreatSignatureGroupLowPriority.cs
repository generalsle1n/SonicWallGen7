...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "security_action_profiles_threat_signature_group_low_priority")]
    public partial class SecurityActionProfilesThreatSignatureGroupLowPriority : IEquatable<SecurityActionProfilesThreatSignatureGroupLowPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityActionProfilesThreatSignatureGroupLowPriority" /> class.
        /// </summary>
        ...
        public SecurityActionProfilesThreatSignatureGroupLowPriority(bool preventAll = default(bool), bool packetMonitorAll = default(bool), bool logAll = default(bool), decimal logRedundancy = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityActionProfilesThreatSignatureGroupLowPriority {\n");
        ...
        {
            return this.Equals(input as SecurityActionProfilesThreatSignatureGroupLowPriority);
        }

        /// <summary>
        /// Returns true if SecurityActionProfilesThreatSignatureGroupLowPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityActionProfilesThreatSignatureGroupLowPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityActionProfilesThreatSignatureGroupLowPriority input)
        {
            if (input == null)
            {
                return false;
