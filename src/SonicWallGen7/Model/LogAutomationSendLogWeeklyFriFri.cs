...
namespace SonicWallGen7.Model
{
    ...
    /// Friday.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_weekly_fri_fri")]
    public partial class LogAutomationSendLogWeeklyFriFri : IEquatable<LogAutomationSendLogWeeklyFriFri>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogWeeklyFriFri" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogWeeklyFriFri(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogWeeklyFriFri {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogWeeklyFriFri);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogWeeklyFriFri instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogWeeklyFriFri to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogWeeklyFriFri input)
        {
            if (input == null)
            {
                return false;
