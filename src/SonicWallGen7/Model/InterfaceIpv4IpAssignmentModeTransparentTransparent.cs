...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interface_ipv4_ip_assignment_mode_transparent_transparent")]
    public partial class InterfaceIpv4IpAssignmentModeTransparentTransparent : IEquatable<InterfaceIpv4IpAssignmentModeTransparentTransparent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceIpv4IpAssignmentModeTransparentTransparent" /> class.
        /// </summary>
        ...
        public InterfaceIpv4IpAssignmentModeTransparentTransparent(InterfaceIpv4IpAssignmentModeTransparentTransparentTransparentRange transparentRange = default(InterfaceIpv4IpAssignmentModeTransparentTransparentTransparentRange), bool gratuitousArpWanForwarding = default(bool), bool gratuitousArpWanGeneration = default(bool))
        {
        ...
        public InterfaceIpv4IpAssignmentModeTransparentTransparentTransparentRange TransparentRange { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InterfaceIpv4IpAssignmentModeTransparentTransparent {\n");
        ...
        {
            return this.Equals(input as InterfaceIpv4IpAssignmentModeTransparentTransparent);
        }

        /// <summary>
        /// Returns true if InterfaceIpv4IpAssignmentModeTransparentTransparent instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfaceIpv4IpAssignmentModeTransparentTransparent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfaceIpv4IpAssignmentModeTransparentTransparent input)
        {
            if (input == null)
            {
                return false;
