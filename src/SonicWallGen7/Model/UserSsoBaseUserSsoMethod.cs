...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user_sso_base_user_sso_method")]
    public partial class UserSsoBaseUserSsoMethod : IEquatable<UserSsoBaseUserSsoMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserSsoBaseUserSsoMethod" /> class.
        /// </summary>
        ...
        public UserSsoBaseUserSsoMethod(bool ssoAgent = default(bool), bool terminalServicesAgent = default(bool), UserSsoBaseUserSsoMethodBrowserNtlm browserNtlm = default(UserSsoBaseUserSsoMethodBrowserNtlm), bool radiusAccounting = default(bool), bool thirdPartyApi = default(bool), bool captureClient = default(bool))
        {
        ...
        public UserSsoBaseUserSsoMethodBrowserNtlm BrowserNtlm { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserSsoBaseUserSsoMethod {\n");
        ...
        {
            return this.Equals(input as UserSsoBaseUserSsoMethod);
        }

        /// <summary>
        /// Returns true if UserSsoBaseUserSsoMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of UserSsoBaseUserSsoMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserSsoBaseUserSsoMethod input)
        {
            if (input == null)
            {
                return false;
