...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "log_syslog_servers")]
    public partial class LogSyslogServers : IEquatable<LogSyslogServers>, IValidatableObject
    {
        /// <summary>
        /// Syslog server type.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogSyslogServers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LogSyslogServers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LogSyslogServers" /> class.
        /// </summary>
        ...
        public LogSyslogServers(LogSyslogServersAddress address = default(LogSyslogServersAddress), decimal? port = default(decimal?), decimal? profile = default(decimal?), TypeEnum? type = default(TypeEnum?), FacilityEnum? facility = default(FacilityEnum?), FormatEnum? format = default(FormatEnum?), string id = default(string), bool enabled = default(bool), LogSyslogServersEventRateLimiting eventRateLimiting = default(LogSyslogServersEventRateLimiting), LogSyslogServersDataRateLimiting dataRateLimiting = default(LogSyslogServersDataRateLimiting), string outboundInterface = default(string), string localInterface = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for LogSyslogServers and cannot be null");
            }
            this.Address = address;
            // to ensure "port" is required (not null)
            if (port == null)
            {
                throw new ArgumentNullException("port is a required property for LogSyslogServers and cannot be null");
            }
            this.Port = port;
            // to ensure "profile" is required (not null)
            if (profile == null)
            {
                throw new ArgumentNullException("profile is a required property for LogSyslogServers and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogSyslogServers {\n");
        ...
        {
            return this.Equals(input as LogSyslogServers);
        }

        /// <summary>
        /// Returns true if LogSyslogServers instances are equal
        /// </summary>
        /// <param name="input">Instance of LogSyslogServers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogSyslogServers input)
        {
            if (input == null)
            {
                return false;
