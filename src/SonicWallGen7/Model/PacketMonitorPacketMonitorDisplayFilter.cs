...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "packet_monitor_packet_monitor_display_filter")]
    public partial class PacketMonitorPacketMonitorDisplayFilter : IEquatable<PacketMonitorPacketMonitorDisplayFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PacketMonitorPacketMonitorDisplayFilter" /> class.
        /// </summary>
        /// <param name="interfaces">Specify name of interface(s) on which packet filter needs                to be performed (maximum 10)..</param>
        /// <param name="etherTypes">Specify name of ether type(s) on which packet filter needs                to be performed..</param>
        /// <param name="ipTypes">Specify name of ip type(s) on which packet filter needs                to be performed..</param>
        /// <param name="sourceIps">Specify source IP addresses on which packet filter needs to                be performed..</param>
        /// <param name="sourcePorts">Specify source TCP/UDP ports on which packet filter needs to                be performed..</param>
        /// <param name="destinationIps">Specify destination IP addresses on which packet filter needs                to be performed..</param>
        /// <param name="destinationPorts">Specify destination TCP/UDP ports on which packet filter needs                to be performed..</param>
        /// <param name="bidirectional">Enable bidirectional address and port matching..</param>
        /// <param name="status">status.</param>
        public PacketMonitorPacketMonitorDisplayFilter(string interfaces = default(string), string etherTypes = default(string), string ipTypes = default(string), string sourceIps = default(string), string sourcePorts = default(string), string destinationIps = default(string), string destinationPorts = default(string), bool bidirectional = default(bool), PacketMonitorPacketMonitorDisplayFilterStatus status = default(PacketMonitorPacketMonitorDisplayFilterStatus))
        {
        ...
        /// </summary>
        /// <value>Specify name of interface(s) on which packet filter needs                to be performed (maximum 10).</value>
        [DataMember(Name = "interfaces", EmitDefaultValue = false)]
        public string Interfaces { get; set; }

        /// <summary>
        /// Specify name of ether type(s) on which packet filter needs                to be performed.
        /// </summary>
        /// <value>Specify name of ether type(s) on which packet filter needs                to be performed.</value>
        [DataMember(Name = "ether_types", EmitDefaultValue = false)]
        public string EtherTypes { get; set; }

        /// <summary>
        /// Specify name of ip type(s) on which packet filter needs                to be performed.
        /// </summary>
        /// <value>Specify name of ip type(s) on which packet filter needs                to be performed.</value>
        ...
        /// </summary>
        /// <value>Specify source IP addresses on which packet filter needs to                be performed.</value>
        ...
        /// </summary>
        /// <value>Specify source TCP/UDP ports on which packet filter needs to                be performed.</value>
        ...
        /// </summary>
        /// <value>Specify destination IP addresses on which packet filter needs                to be performed.</value>
        ...
        /// </summary>
        /// <value>Specify destination TCP/UDP ports on which packet filter needs                to be performed.</value>
        ...
        public PacketMonitorPacketMonitorDisplayFilterStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PacketMonitorPacketMonitorDisplayFilter {\n");
        ...
        {
            return this.Equals(input as PacketMonitorPacketMonitorDisplayFilter);
        }

        /// <summary>
        /// Returns true if PacketMonitorPacketMonitorDisplayFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of PacketMonitorPacketMonitorDisplayFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PacketMonitorPacketMonitorDisplayFilter input)
        {
            if (input == null)
            {
                return false;
