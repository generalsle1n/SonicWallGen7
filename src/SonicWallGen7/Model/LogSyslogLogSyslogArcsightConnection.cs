...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "log_syslog_log_syslog_arcsight_connection")]
    public partial class LogSyslogLogSyslogArcsightConnection : IEquatable<LogSyslogLogSyslogArcsightConnection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogSyslogLogSyslogArcsightConnection" /> class.
        /// </summary>
        ...
        public LogSyslogLogSyslogArcsightConnection(bool bytesRcvd = default(bool), bool bytesSent = default(bool), bool pktsRcvd = default(bool), bool pktsSent = default(bool), bool user = default(bool), bool connDuration = default(bool), bool sessionType = default(bool), bool sessionTime = default(bool), bool srcVpn = default(bool), bool dstVpn = default(bool), bool srcZone = default(bool), bool dstZone = default(bool), bool clientPolicy = default(bool), bool interfaceStats = default(bool), bool sonicpointStats = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogSyslogLogSyslogArcsightConnection {\n");
        ...
        {
            return this.Equals(input as LogSyslogLogSyslogArcsightConnection);
        }

        /// <summary>
        /// Returns true if LogSyslogLogSyslogArcsightConnection instances are equal
        /// </summary>
        /// <param name="input">Instance of LogSyslogLogSyslogArcsightConnection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogSyslogLogSyslogArcsightConnection input)
        {
            if (input == null)
            {
                return false;
