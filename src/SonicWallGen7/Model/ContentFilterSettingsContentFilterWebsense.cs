...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "content_filter_settings_content_filter_websense")]
    public partial class ContentFilterSettingsContentFilterWebsense : IEquatable<ContentFilterSettingsContentFilterWebsense>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentFilterSettingsContentFilterWebsense" /> class.
        /// </summary>
        ...
        public ContentFilterSettingsContentFilterWebsense(string server = default(string), decimal port = default(decimal), string userName = default(string), decimal maxUrlCaches = default(decimal), bool httpsContentFiltering = default(bool), ContentFilterSettingsContentFilterWebsenseProbe probe = default(ContentFilterSettingsContentFilterWebsenseProbe), bool blockIfServerUnavailable = default(bool), decimal serverTimeout = default(decimal), ContentFilterSettingsContentFilterWebsenseBlock block = default(ContentFilterSettingsContentFilterWebsenseBlock), ContentFilterSettingsContentFilterWebsenseExclude exclude = default(ContentFilterSettingsContentFilterWebsenseExclude), ContentFilterSettingsContentFilterWebsenseBlockingPage blockingPage = default(ContentFilterSettingsContentFilterWebsenseBlockingPage))
        {
            this.Server = server;
            this.Port = port;
        ...
        public ContentFilterSettingsContentFilterWebsenseExclude Exclude { get; set; }

        /// <summary>
        /// Gets or Sets BlockingPage
        /// </summary>
        [DataMember(Name = "blocking_page", EmitDefaultValue = false)]
        public ContentFilterSettingsContentFilterWebsenseBlockingPage BlockingPage { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContentFilterSettingsContentFilterWebsense {\n");
        ...
        {
            return this.Equals(input as ContentFilterSettingsContentFilterWebsense);
        }

        /// <summary>
        /// Returns true if ContentFilterSettingsContentFilterWebsense instances are equal
        /// </summary>
        /// <param name="input">Instance of ContentFilterSettingsContentFilterWebsense to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContentFilterSettingsContentFilterWebsense input)
        {
            if (input == null)
            {
                return false;
