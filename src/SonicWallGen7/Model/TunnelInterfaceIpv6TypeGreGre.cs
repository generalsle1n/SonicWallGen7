...
namespace SonicWallGen7.Model
{
    ...
    /// GRE tunnel.
    /// </summary>
    [DataContract(Name = "tunnel_interface_ipv6_type_gre_gre")]
    public partial class TunnelInterfaceIpv6TypeGreGre : IEquatable<TunnelInterfaceIpv6TypeGreGre>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TunnelInterfaceIpv6TypeGreGre" /> class.
        /// </summary>
        ...
        public TunnelInterfaceIpv6TypeGreGre(string ip = default(string), decimal prefixLength = default(decimal), TunnelInterfaceIpv6TypeGreGreRemote remote = default(TunnelInterfaceIpv6TypeGreGreRemote), TunnelInterfaceIpv6TypeGreGreBoundTo boundTo = default(TunnelInterfaceIpv6TypeGreGreBoundTo), decimal linkMtu = default(decimal))
        {
            this.Ip = ip;
        ...
        public TunnelInterfaceIpv6TypeGreGreRemote Remote { get; set; }

        /// <summary>
        /// Gets or Sets BoundTo
        /// </summary>
        [DataMember(Name = "bound_to", EmitDefaultValue = false)]
        public TunnelInterfaceIpv6TypeGreGreBoundTo BoundTo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TunnelInterfaceIpv6TypeGreGre {\n");
        ...
        {
            return this.Equals(input as TunnelInterfaceIpv6TypeGreGre);
        }

        /// <summary>
        /// Returns true if TunnelInterfaceIpv6TypeGreGre instances are equal
        /// </summary>
        /// <param name="input">Instance of TunnelInterfaceIpv6TypeGreGre to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TunnelInterfaceIpv6TypeGreGre input)
        {
            if (input == null)
            {
                return false;
