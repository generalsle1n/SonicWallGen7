...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "packet_replay_packet_crafting_udp_packet_replay_packet_crafting_udp_action_val")]
    public partial class PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal : IEquatable<PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal" /> class.
        /// </summary>
        ...
        /// <param name="srcPort">Enter Source Port * Set to null to represent an unconfigured state..</param>
        /// <param name="dstPort">Enter Destination Port * Set to null to represent an unconfigured state..</param>
        /// <param name="payload">Enter Payload * Set to null to represent an unconfigured state..</param>
        public PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal(decimal? destIface = default(decimal?), string destMac = default(string), string srcMac = default(string), decimal etherType = default(decimal), decimal ipAddrType = default(decimal), string srcAddr = default(string), string destAddr = default(string), decimal? ttlVal = default(decimal?), decimal? srcPort = default(decimal?), decimal? dstPort = default(decimal?), string payload = default(string))
        {
        ...
        /// <summary>
        /// Enter Source Port * Set to null to represent an unconfigured state.
        /// </summary>
        /// <value>Enter Source Port * Set to null to represent an unconfigured state.</value>
        [DataMember(Name = "src_port", EmitDefaultValue = true)]
        public decimal? SrcPort { get; set; }

        /// <summary>
        /// Enter Destination Port * Set to null to represent an unconfigured state.
        /// </summary>
        /// <value>Enter Destination Port * Set to null to represent an unconfigured state.</value>
        [DataMember(Name = "dst_port", EmitDefaultValue = true)]
        public decimal? DstPort { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal {\n");
        ...
        {
            return this.Equals(input as PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal);
        }

        /// <summary>
        /// Returns true if PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal instances are equal
        /// </summary>
        /// <param name="input">Instance of PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PacketReplayPacketCraftingUdpPacketReplayPacketCraftingUdpActionVal input)
        {
            if (input == null)
            {
                return false;
