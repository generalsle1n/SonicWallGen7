...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ssl_vpn_bookmark_service_rdp")]
    public partial class SslVpnBookmarkServiceRdp : IEquatable<SslVpnBookmarkServiceRdp>, IValidatableObject
    {
        /// <summary>
        /// Set screen size.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SslVpnBookmarkServiceRdp" /> class.
        /// </summary>
        ...
        public SslVpnBookmarkServiceRdp(ScreenSizeEnum? screenSize = default(ScreenSizeEnum?), ColorsEnum? colors = default(ColorsEnum?), string applicationPath = default(string), string startInFolder = default(string), SslVpnBookmarkServiceRdpAutomaticLogin automaticLogin = default(SslVpnBookmarkServiceRdpAutomaticLogin), bool redirectClipboard = default(bool), bool redirectAudio = default(bool), bool autoReconnection = default(bool), bool desktopBackground = default(bool), bool windowDrag = default(bool), bool animation = default(bool), bool displayOnMobile = default(bool))
        {
        ...
        public SslVpnBookmarkServiceRdpAutomaticLogin AutomaticLogin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SslVpnBookmarkServiceRdp {\n");
        ...
        {
            return this.Equals(input as SslVpnBookmarkServiceRdp);
        }

        /// <summary>
        /// Returns true if SslVpnBookmarkServiceRdp instances are equal
        /// </summary>
        /// <param name="input">Instance of SslVpnBookmarkServiceRdp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SslVpnBookmarkServiceRdp input)
        {
            if (input == null)
            {
                return false;
