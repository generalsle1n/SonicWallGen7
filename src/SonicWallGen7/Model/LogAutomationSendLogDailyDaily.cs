...
namespace SonicWallGen7.Model
{
    ...
    /// Daily.
    /// </summary>
    [DataContract(Name = "log_automation_send_log_daily_daily")]
    public partial class LogAutomationSendLogDailyDaily : IEquatable<LogAutomationSendLogDailyDaily>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAutomationSendLogDailyDaily" /> class.
        /// </summary>
        ...
        public LogAutomationSendLogDailyDaily(decimal? hour = default(decimal?), decimal? minute = default(decimal?))
        {
            this.Hour = hour;
            this.Minute = minute;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogAutomationSendLogDailyDaily {\n");
        ...
        {
            return this.Equals(input as LogAutomationSendLogDailyDaily);
        }

        /// <summary>
        /// Returns true if LogAutomationSendLogDailyDaily instances are equal
        /// </summary>
        /// <param name="input">Instance of LogAutomationSendLogDailyDaily to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAutomationSendLogDailyDaily input)
        {
            if (input == null)
            {
                return false;
