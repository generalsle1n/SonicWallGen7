...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "gateway_antivirus_gateway_antivirus_restrict_packed_executables")]
    public partial class GatewayAntivirusGatewayAntivirusRestrictPackedExecutables : IEquatable<GatewayAntivirusGatewayAntivirusRestrictPackedExecutables>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayAntivirusGatewayAntivirusRestrictPackedExecutables" /> class.
        /// </summary>
        ...
        public GatewayAntivirusGatewayAntivirusRestrictPackedExecutables(bool http = default(bool), bool ftp = default(bool), bool imap = default(bool), bool smtp = default(bool), bool pop3 = default(bool), bool cifsNetbios = default(bool))
        {
            this.Http = http;
            this.Ftp = ftp;
            this.Imap = imap;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GatewayAntivirusGatewayAntivirusRestrictPackedExecutables {\n");
        ...
        {
            return this.Equals(input as GatewayAntivirusGatewayAntivirusRestrictPackedExecutables);
        }

        /// <summary>
        /// Returns true if GatewayAntivirusGatewayAntivirusRestrictPackedExecutables instances are equal
        /// </summary>
        /// <param name="input">Instance of GatewayAntivirusGatewayAntivirusRestrictPackedExecutables to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GatewayAntivirusGatewayAntivirusRestrictPackedExecutables input)
        {
            if (input == null)
            {
                return false;
