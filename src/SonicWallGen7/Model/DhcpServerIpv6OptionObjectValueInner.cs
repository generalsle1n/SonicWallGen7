...
{
    /// <summary>
    /// DhcpServerIpv6OptionObjectValueInner
    /// </summary>
    [DataContract(Name = "dhcp_server_ipv6_option_object_value_inner")]
    public partial class DhcpServerIpv6OptionObjectValueInner : IEquatable<DhcpServerIpv6OptionObjectValueInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DhcpServerIpv6OptionObjectValueInner" /> class.
        /// </summary>
        /// <param name="ip">Option object type: IP address..</param>
        /// <param name="fourByte">Option object type: four byte data..</param>
        ...
        /// <param name="boolean">Option object type: boolean..</param>
        /// <param name="domainName">Option object type: domain name..</param>
        public DhcpServerIpv6OptionObjectValueInner(string ip = default(string), string fourByte = default(string), string twoByte = default(string), string oneByte = default(string), string varString = default(string), decimal boolean = default(decimal), string domainName = default(string))
        {
            this.Ip = ip;
        ...
        /// <summary>
        /// Option object type: four byte data.
        /// </summary>
        /// <value>Option object type: four byte data.</value>
        ...
        /// <summary>
        /// Option object type: boolean.
        /// </summary>
        /// <value>Option object type: boolean.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DhcpServerIpv6OptionObjectValueInner {\n");
        ...
        {
            return this.Equals(input as DhcpServerIpv6OptionObjectValueInner);
        }

        /// <summary>
        /// Returns true if DhcpServerIpv6OptionObjectValueInner instances are equal
        /// </summary>
        /// <param name="input">Instance of DhcpServerIpv6OptionObjectValueInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DhcpServerIpv6OptionObjectValueInner input)
        {
            if (input == null)
            {
                return false;
