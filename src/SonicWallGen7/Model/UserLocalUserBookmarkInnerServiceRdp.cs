...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "user_local_user_bookmark_inner_service_rdp")]
    public partial class UserLocalUserBookmarkInnerServiceRdp : IEquatable<UserLocalUserBookmarkInnerServiceRdp>, IValidatableObject
    {
        /// <summary>
        /// Set screen size.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserLocalUserBookmarkInnerServiceRdp" /> class.
        /// </summary>
        ...
        public UserLocalUserBookmarkInnerServiceRdp(ScreenSizeEnum? screenSize = default(ScreenSizeEnum?), ColorsEnum? colors = default(ColorsEnum?), string applicationPath = default(string), string startInFolder = default(string), UserLocalUserBookmarkInnerServiceRdpAutomaticLogin automaticLogin = default(UserLocalUserBookmarkInnerServiceRdpAutomaticLogin), bool redirectClipboard = default(bool), bool redirectAudio = default(bool), bool autoReconnection = default(bool), bool desktopBackground = default(bool), bool windowDrag = default(bool), bool animation = default(bool), bool displayOnMobile = default(bool))
        {
        ...
        public UserLocalUserBookmarkInnerServiceRdpAutomaticLogin AutomaticLogin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserLocalUserBookmarkInnerServiceRdp {\n");
        ...
        {
            return this.Equals(input as UserLocalUserBookmarkInnerServiceRdp);
        }

        /// <summary>
        /// Returns true if UserLocalUserBookmarkInnerServiceRdp instances are equal
        /// </summary>
        /// <param name="input">Instance of UserLocalUserBookmarkInnerServiceRdp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLocalUserBookmarkInnerServiceRdp input)
        {
            if (input == null)
            {
                return false;
