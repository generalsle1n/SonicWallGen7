...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "security_action_profiles_threat_signature_group_high_priority")]
    public partial class SecurityActionProfilesThreatSignatureGroupHighPriority : IEquatable<SecurityActionProfilesThreatSignatureGroupHighPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityActionProfilesThreatSignatureGroupHighPriority" /> class.
        /// </summary>
        ...
        public SecurityActionProfilesThreatSignatureGroupHighPriority(bool preventAll = default(bool), bool packetMonitorAll = default(bool), bool logAll = default(bool), decimal logRedundancy = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityActionProfilesThreatSignatureGroupHighPriority {\n");
        ...
        {
            return this.Equals(input as SecurityActionProfilesThreatSignatureGroupHighPriority);
        }

        /// <summary>
        /// Returns true if SecurityActionProfilesThreatSignatureGroupHighPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityActionProfilesThreatSignatureGroupHighPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityActionProfilesThreatSignatureGroupHighPriority input)
        {
            if (input == null)
            {
                return false;
