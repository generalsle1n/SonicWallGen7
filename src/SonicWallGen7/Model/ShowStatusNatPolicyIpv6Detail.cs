...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_nat_policy_ipv6_detail")]
    public partial class ShowStatusNatPolicyIpv6Detail : IEquatable<ShowStatusNatPolicyIpv6Detail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusNatPolicyIpv6Detail" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusNatPolicyIpv6Detail {\n");
        ...
        {
            return this.Equals(input as ShowStatusNatPolicyIpv6Detail);
        }

        /// <summary>
        /// Returns true if ShowStatusNatPolicyIpv6Detail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusNatPolicyIpv6Detail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusNatPolicyIpv6Detail input)
        {
            if (input == null)
            {
                return false;
