...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "security_action_profiles_threat_signature_group_medium_priority")]
    public partial class SecurityActionProfilesThreatSignatureGroupMediumPriority : IEquatable<SecurityActionProfilesThreatSignatureGroupMediumPriority>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityActionProfilesThreatSignatureGroupMediumPriority" /> class.
        /// </summary>
        ...
        public SecurityActionProfilesThreatSignatureGroupMediumPriority(bool preventAll = default(bool), bool packetMonitorAll = default(bool), bool logAll = default(bool), decimal logRedundancy = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SecurityActionProfilesThreatSignatureGroupMediumPriority {\n");
        ...
        {
            return this.Equals(input as SecurityActionProfilesThreatSignatureGroupMediumPriority);
        }

        /// <summary>
        /// Returns true if SecurityActionProfilesThreatSignatureGroupMediumPriority instances are equal
        /// </summary>
        /// <param name="input">Instance of SecurityActionProfilesThreatSignatureGroupMediumPriority to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecurityActionProfilesThreatSignatureGroupMediumPriority input)
        {
            if (input == null)
            {
                return false;
