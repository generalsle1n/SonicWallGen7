...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "network_monitor_ipv4_policy_ipv4_interval")]
    public partial class NetworkMonitorIpv4PolicyIpv4Interval : IEquatable<NetworkMonitorIpv4PolicyIpv4Interval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkMonitorIpv4PolicyIpv4Interval" /> class.
        /// </summary>
        ...
        public NetworkMonitorIpv4PolicyIpv4Interval(decimal missed = default(decimal), decimal successful = default(decimal))
        {
            this.Missed = missed;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NetworkMonitorIpv4PolicyIpv4Interval {\n");
        ...
        {
            return this.Equals(input as NetworkMonitorIpv4PolicyIpv4Interval);
        }

        /// <summary>
        /// Returns true if NetworkMonitorIpv4PolicyIpv4Interval instances are equal
        /// </summary>
        /// <param name="input">Instance of NetworkMonitorIpv4PolicyIpv4Interval to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkMonitorIpv4PolicyIpv4Interval input)
        {
            if (input == null)
            {
                return false;
