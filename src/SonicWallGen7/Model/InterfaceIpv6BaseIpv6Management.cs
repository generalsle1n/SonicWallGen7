...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "interface_ipv6_base_ipv6_management")]
    public partial class InterfaceIpv6BaseIpv6Management : IEquatable<InterfaceIpv6BaseIpv6Management>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterfaceIpv6BaseIpv6Management" /> class.
        /// </summary>
        ...
        public InterfaceIpv6BaseIpv6Management(bool http = default(bool), bool https = default(bool), bool ping = default(bool), bool snmp = default(bool), bool ssh = default(bool))
        {
            this.Http = http;
            this.Https = https;
            this.Ping = ping;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InterfaceIpv6BaseIpv6Management {\n");
        ...
        {
            return this.Equals(input as InterfaceIpv6BaseIpv6Management);
        }

        /// <summary>
        /// Returns true if InterfaceIpv6BaseIpv6Management instances are equal
        /// </summary>
        /// <param name="input">Instance of InterfaceIpv6BaseIpv6Management to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InterfaceIpv6BaseIpv6Management input)
        {
            if (input == null)
            {
                return false;
