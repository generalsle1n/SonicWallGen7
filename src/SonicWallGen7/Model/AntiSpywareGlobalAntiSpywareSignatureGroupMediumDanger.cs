...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "anti_spyware_global_anti_spyware_signature_group_medium_danger")]
    public partial class AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger : IEquatable<AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger" /> class.
        /// </summary>
        /// <param name="preventAll">Prevent all..</param>
        /// <param name="detectAll">Detect all..</param>
        /// <param name="logRedundancy">logRedundancy.</param>
        public AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger(bool preventAll = default(bool), bool detectAll = default(bool), AntiSpywareGlobalAntiSpywareSignatureGroupHighDangerLogRedundancy logRedundancy = default(AntiSpywareGlobalAntiSpywareSignatureGroupHighDangerLogRedundancy))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger {\n");
        ...
        {
            return this.Equals(input as AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger);
        }

        /// <summary>
        /// Returns true if AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger instances are equal
        /// </summary>
        /// <param name="input">Instance of AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AntiSpywareGlobalAntiSpywareSignatureGroupMediumDanger input)
        {
            if (input == null)
            {
                return false;
