...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_nat_policy_detail")]
    public partial class ShowStatusNatPolicyDetail : IEquatable<ShowStatusNatPolicyDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusNatPolicyDetail" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusNatPolicyDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusNatPolicyDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusNatPolicyDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusNatPolicyDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusNatPolicyDetail input)
        {
            if (input == null)
            {
                return false;
