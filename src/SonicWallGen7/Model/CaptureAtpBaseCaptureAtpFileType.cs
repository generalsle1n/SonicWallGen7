...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "capture_atp_base_capture_atp_file_type")]
    public partial class CaptureAtpBaseCaptureAtpFileType : IEquatable<CaptureAtpBaseCaptureAtpFileType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaptureAtpBaseCaptureAtpFileType" /> class.
        /// </summary>
        ...
        public CaptureAtpBaseCaptureAtpFileType(bool exe = default(bool), bool pdf = default(bool), bool office = default(bool), bool officex = default(bool), bool archives = default(bool))
        {
            this.Exe = exe;
            this.Pdf = pdf;
            this.Office = office;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CaptureAtpBaseCaptureAtpFileType {\n");
        ...
        {
            return this.Equals(input as CaptureAtpBaseCaptureAtpFileType);
        }

        /// <summary>
        /// Returns true if CaptureAtpBaseCaptureAtpFileType instances are equal
        /// </summary>
        /// <param name="input">Instance of CaptureAtpBaseCaptureAtpFileType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaptureAtpBaseCaptureAtpFileType input)
        {
            if (input == null)
            {
                return false;
