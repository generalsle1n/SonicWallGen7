...
{
    /// <summary>
    /// ShowStatusInterfaceListInner
    /// </summary>
    [DataContract(Name = "show_status_interface_list_inner")]
    public partial class ShowStatusInterfaceListInner : IEquatable<ShowStatusInterfaceListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusInterfaceListInner" /> class.
        /// </summary>
        ...
        public ShowStatusInterfaceListInner(string interfaceName = default(string), string rxUnicastPackets = default(string), string rxBroadcastPackets = default(string), string rxErrors = default(string), string rxBytes = default(string), string txUnicastPackets = default(string), string txBroadcastPackets = default(string), string txErrors = default(string), string txBytes = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusInterfaceListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusInterfaceListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusInterfaceListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusInterfaceListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusInterfaceListInner input)
        {
            if (input == null)
            {
                return false;
