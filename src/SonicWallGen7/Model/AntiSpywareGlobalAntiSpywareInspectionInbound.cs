...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "anti_spyware_global_anti_spyware_inspection_inbound")]
    public partial class AntiSpywareGlobalAntiSpywareInspectionInbound : IEquatable<AntiSpywareGlobalAntiSpywareInspectionInbound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AntiSpywareGlobalAntiSpywareInspectionInbound" /> class.
        /// </summary>
        ...
        public AntiSpywareGlobalAntiSpywareInspectionInbound(bool http = default(bool), bool ftp = default(bool), bool imap = default(bool), bool smtp = default(bool), bool pop3 = default(bool))
        {
            this.Http = http;
            this.Ftp = ftp;
            this.Imap = imap;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AntiSpywareGlobalAntiSpywareInspectionInbound {\n");
        ...
        {
            return this.Equals(input as AntiSpywareGlobalAntiSpywareInspectionInbound);
        }

        /// <summary>
        /// Returns true if AntiSpywareGlobalAntiSpywareInspectionInbound instances are equal
        /// </summary>
        /// <param name="input">Instance of AntiSpywareGlobalAntiSpywareInspectionInbound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AntiSpywareGlobalAntiSpywareInspectionInbound input)
        {
            if (input == null)
            {
                return false;
