...
{
    /// <summary>
    /// ShowStatusArpCacheListInner
    /// </summary>
    [DataContract(Name = "show_status_arp_cache_list_inner")]
    public partial class ShowStatusArpCacheListInner : IEquatable<ShowStatusArpCacheListInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusArpCacheListInner" /> class.
        /// </summary>
        ...
        public ShowStatusArpCacheListInner(string ipAddress = default(string), string type = default(string), string macAddress = default(string), string vendor = default(string), string varInterface = default(string), string timeout = default(string), string expiresInMinutes = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusArpCacheListInner {\n");
        ...
        {
            return this.Equals(input as ShowStatusArpCacheListInner);
        }

        /// <summary>
        /// Returns true if ShowStatusArpCacheListInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusArpCacheListInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusArpCacheListInner input)
        {
            if (input == null)
            {
                return false;
