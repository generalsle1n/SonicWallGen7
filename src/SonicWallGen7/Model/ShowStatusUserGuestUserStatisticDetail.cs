...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_user_guest_user_statistic_detail")]
    public partial class ShowStatusUserGuestUserStatisticDetail : IEquatable<ShowStatusUserGuestUserStatisticDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusUserGuestUserStatisticDetail" /> class.
        /// </summary>
        ...
        public ShowStatusUserGuestUserStatisticDetail(string userName = default(string), string userIp = default(string), string rxBytes = default(string), string rxPackets = default(string), string txBytes = default(string), string txPackets = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusUserGuestUserStatisticDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusUserGuestUserStatisticDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusUserGuestUserStatisticDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusUserGuestUserStatisticDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusUserGuestUserStatisticDetail input)
        {
            if (input == null)
            {
                return false;
