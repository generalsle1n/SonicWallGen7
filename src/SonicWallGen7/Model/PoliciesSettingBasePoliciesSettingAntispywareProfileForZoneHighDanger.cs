...
namespace SonicWallGen7.Model
{
    ...
    /// High danger attacks.
    /// </summary>
    [DataContract(Name = "policies_setting_base_policies_setting_antispyware_profile_for_zone_high_danger")]
    public partial class PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger : IEquatable<PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger" /> class.
        /// </summary>
        ...
        public PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger(bool preventAll = default(bool), bool packetMonitorAll = default(bool), bool logAll = default(bool), decimal logRedundancy = default(decimal))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger {\n");
        ...
        {
            return this.Equals(input as PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger);
        }

        /// <summary>
        /// Returns true if PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger instances are equal
        /// </summary>
        /// <param name="input">Instance of PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PoliciesSettingBasePoliciesSettingAntispywareProfileForZoneHighDanger input)
        {
            if (input == null)
            {
                return false;
