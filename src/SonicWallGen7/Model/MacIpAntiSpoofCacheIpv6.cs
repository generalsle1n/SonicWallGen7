...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "mac_ip_anti_spoof_cache_ipv6")]
    public partial class MacIpAntiSpoofCacheIpv6 : IEquatable<MacIpAntiSpoofCacheIpv6>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MacIpAntiSpoofCacheIpv6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MacIpAntiSpoofCacheIpv6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MacIpAntiSpoofCacheIpv6" /> class.
        /// </summary>
        ...
        public MacIpAntiSpoofCacheIpv6(string ip = default(string), string mac = default(string), string varInterface = default(string), bool router = default(bool), bool blacklisted = default(bool))
        {
            // to ensure "ip" is required (not null)
            if (ip == null)
            {
                throw new ArgumentNullException("ip is a required property for MacIpAntiSpoofCacheIpv6 and cannot be null");
            }
            this.Ip = ip;
            // to ensure "mac" is required (not null)
            if (mac == null)
            {
                throw new ArgumentNullException("mac is a required property for MacIpAntiSpoofCacheIpv6 and cannot be null");
            }
            this.Mac = mac;
            // to ensure "varInterface" is required (not null)
            if (varInterface == null)
            {
                throw new ArgumentNullException("varInterface is a required property for MacIpAntiSpoofCacheIpv6 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MacIpAntiSpoofCacheIpv6 {\n");
        ...
        {
            return this.Equals(input as MacIpAntiSpoofCacheIpv6);
        }

        /// <summary>
        /// Returns true if MacIpAntiSpoofCacheIpv6 instances are equal
        /// </summary>
        /// <param name="input">Instance of MacIpAntiSpoofCacheIpv6 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MacIpAntiSpoofCacheIpv6 input)
        {
            if (input == null)
            {
                return false;
