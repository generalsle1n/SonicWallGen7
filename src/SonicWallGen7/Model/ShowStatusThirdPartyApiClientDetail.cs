...
namespace SonicWallGen7.Model
{
    ...
    /// </summary>
    [DataContract(Name = "show_status_third_party_api_client_detail")]
    public partial class ShowStatusThirdPartyApiClientDetail : IEquatable<ShowStatusThirdPartyApiClientDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShowStatusThirdPartyApiClientDetail" /> class.
        /// </summary>
        ...
        public ShowStatusThirdPartyApiClientDetail(string varClient = default(string), string ipAddress = default(string), string status = default(string), string timeSinceLastRequest = default(string), string totalRequestsReceived = default(string), string ignoredRequests = default(string), string requestsThatFaieldAuth = default(string), string totalPostRequestsReceived = default(string), string badPostRequestsReceived = default(string), string totalDeleteRequestsReceived = default(string), string badDeleteRequestsReceived = default(string), string totalOptionsRequestsReceived = default(string), string badOptionsRequestsReceived = default(string), string otherUnsupportedRequests = default(string), string successfulUserLogins = default(string), string timesSameUserWasAlreadyLoggedIn = default(string), string failedUserLogins = default(string), string userLogouts = default(string), string usersNotFoundErrorsWithDeleteRequests = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowStatusThirdPartyApiClientDetail {\n");
        ...
        {
            return this.Equals(input as ShowStatusThirdPartyApiClientDetail);
        }

        /// <summary>
        /// Returns true if ShowStatusThirdPartyApiClientDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ShowStatusThirdPartyApiClientDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ShowStatusThirdPartyApiClientDetail input)
        {
            if (input == null)
            {
                return false;
