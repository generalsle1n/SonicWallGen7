...
namespace SonicWallGen7.Model
{
    ...
    /// Active-standby mode.
    /// </summary>
    [DataContract(Name = "ha_base_mode_active_standby_active_standby")]
    public partial class HaBaseModeActiveStandbyActiveStandby : IEquatable<HaBaseModeActiveStandbyActiveStandby>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HaBaseModeActiveStandbyActiveStandby" /> class.
        /// </summary>
        ...
        /// <param name="statefulSynchronization">Enable stateful synchronization..</param>
        ...
        public HaBaseModeActiveStandbyActiveStandby(string primarySerial = default(string), string secondarySerial = default(string), bool statefulSynchronization = default(bool), string controlInterface = default(string), string dataInterface = default(string), bool preempt = default(bool), bool encryption = default(bool))
        {
            this.PrimarySerial = primarySerial;
            this.SecondarySerial = secondarySerial;
            this.StatefulSynchronization = statefulSynchronization;
        ...
        /// </summary>
        /// <value>Enable stateful synchronization.</value>
        [DataMember(Name = "stateful_synchronization", EmitDefaultValue = true)]
        public bool StatefulSynchronization { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HaBaseModeActiveStandbyActiveStandby {\n");
            sb.Append("  PrimarySerial: ").Append(PrimarySerial).Append("\n");
            sb.Append("  SecondarySerial: ").Append(SecondarySerial).Append("\n");
            sb.Append("  StatefulSynchronization: ").Append(StatefulSynchronization).Append("\n");
        ...
        {
            return this.Equals(input as HaBaseModeActiveStandbyActiveStandby);
        }

        /// <summary>
        /// Returns true if HaBaseModeActiveStandbyActiveStandby instances are equal
        /// </summary>
        /// <param name="input">Instance of HaBaseModeActiveStandbyActiveStandby to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HaBaseModeActiveStandbyActiveStandby input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.StatefulSynchronization == input.StatefulSynchronization ||
                    this.StatefulSynchronization.Equals(input.StatefulSynchronization)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.StatefulSynchronization.GetHashCode();
