...
namespace SonicWallGen7.Test.Api
{
    ...
    public class UserManagementApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test UserManagementGet
        /// </summary>
        [Fact]
        public void UserManagementGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.UserManagementGet();
            //Assert.IsType<UserManagement>(response);
        }

        /// <summary>
        /// Test UserManagementPut
        /// </summary>
        [Fact]
        public void UserManagementPutTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //UserManagement? userManagement = null;
            //var response = instance.UserManagementPut(userManagement);
